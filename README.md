...
<div class="flourish-embed flourish-chart" data-src="visualisation/5145011"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
<i>Outil utilisé : Flourish</i><br/>
<p style='text-align: justify;'>Pour la seconde visualisation, j'ai décidé d'afficher le prix du gazole en fonction des villes. Pour ce faire, j'ai utilisé la représentation via un column chart, proposé par Flourish. Cette visualisation permet donc d'établir un comparatif du prix du gazole selon les villes, avec un affichage du prix trié de façon décroissante. Ainsi, nous pouvons constater que le prix du gazole est le plus élevé dans l'une des stations-essences situées à Paris. En effet, il faut évidemment prendre en compte que certaines villes peuvent avoir plusieurs stations-essences, avec des prix parfois très différents d'une station à une autre. Pour analyser le tarif du gazole dans une ville en détail, j'ai utilisé l'option "Row filter" de Flourish. Cela m'a permis d'afficher un petit menu interactif en haut à gauche de la visualisation, permettant de sélectionner une ville en particulier, ou alors toutes les villes de France avec "all". De ce fait, en analysant la ville de Paris par exemple, j'ai pu constater qu'elle offrait plusieurs prix pour le carburant gazole : 1,890€/L, 1,589€/L, 1,530€/L, etc. Le prix le plus bas pour le gazole est proposé dans l'une des stations-essences de la ville de Varennes-Saint-Sauveur, avec un tarif très compétitif de 1,138€/L.<br/></p> 
...
<br/>
## Conclusion
<p style='text-align: justify;'>J'ai trouvé la réalisation de ce projet très enrichissante dans le sens où elle m'a permis de me confronter plus en détails à la manipulation des différents outils de dataviz. Cela dit, j'ai rencontré plusieurs difficultés en les utilisant. Pour commencer, lors de la réalisation de ma deuxième datavisualisation (le column chart comparatif du prix du gazole selon les villes), j'ai essayé de modifier le nombre de valeurs que l'on pouvait afficher sur le graphique mais je n'ai pas réussi, ce qui fait que le rendu n'est pas aussi lisible que ce que j'aurais souhaité : il affiche toutes les villes où des stations-services sont présentes. Cependant, j'ai plus ou moins réussi à contourner ce problème en intégrant le menu "Row filter" en haut à gauche, permettant d'afficher le prix du gazole selon une ville en particulier (rendant la lisibilité un peu plus claire).
 </p>
