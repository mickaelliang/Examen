...
<br/>
## Conclusion
<p style='text-align: justify;'>J'ai trouvé la réalisation de ce projet très enrichissante dans le sens où elle m'a permis de me confronter plus en détails à la manipulation des différents outils de dataviz. Cela dit, j'ai rencontré quelques difficultés en les utilisant. Pour la réalisation de ma deuxième datavisualisation (le column chart comparatif du prix des carburants selon les 5 plus grandes villes de France), je voulais au départ afficher un column chart comparatif du prix des selon toutes les villes de France, mais le rendu était illisible de par le nombre de valeurs de mon jeu de données. Même en essayant d'autres outils (datawrapper, rawgraph, palladio) ainsi que d'autres formes de visualisations, l'affichage ne me convenait pas. C'est pourquoi j'ai restreint le comparatif du prix selon les 5 plus grandes villes de France, qui est cela dit tout aussi intéressant. De plus, le menu "Row filter" que j'ai intégré en haut à gauche, permet d'afficher le prix de chacun des carburants selon une ville en particulier, rendant la lisibilité encore plus claire.
 </p>
