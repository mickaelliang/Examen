...
<br/>
## Conclusion
<p style='text-align: justify;'>J'ai trouvé la réalisation de ce projet très enrichissante dans le sens où elle m'a permis de me confronter plus en détails à la manipulation des différents outils de dataviz. Cela dit, j'ai rencontré plusieurs difficultés en les utilisant. Pour commencer, lors de la réalisation de ma deuxième datavisualisation (le column chart comparatif du prix du gazole selon les villes), j'ai essayé de modifier le nombre de valeurs que l'on pouvait afficher sur le graphique mais je n'ai pas réussi, ce qui fait que le rendu n'est pas aussi lisible que ce que je l'aurais souhaité : il affiche toutes les villes où des stations-services sont présentes. Cependant, j'ai plus ou moins réussi à contourner ce problème en intégrant le menu "Row filter" en haut à gauche, permettant d'afficher le prix du gazole selon une ville en particulier (rendant la lisibilité un peu plus claire). Pour continuer, l'affichage par défaut que propose Flourish avec l'affichage des prix des carburants est de deux chiffres après la virgule. Malgré avoir modifié en amont mon jeu de données sur OpenRefine en uniformisant tous les prix à trois chiffres après la virgule, je n'ai pas réussi à modifier l'affichage obtenu sur Flourish. 
 </p>
